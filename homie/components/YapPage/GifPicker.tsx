...
export default function GifPicker({ isOpen, onClose, onGifSelect }: GifPickerProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center" onClick={onClose}>
            <div 
                className="w-full sm:w-[350px] bg-bgPrimary border border-[#666] rounded-t-[15px] sm:rounded-[15px] p-4 mb-16 sm:mb-0"
            ...
            >
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="overflow-y-auto h-[300px] sm:h-[400px]">
                        <Grid
                            key={debouncedQuery}
                            onGifClick={(gif, e) => {
                                e.preventDefault();

...
export default function DeleteAccountModal( {openDeleteModal, setOpenDeleteModal, user} : {openDeleteModal : boolean, setOpenDeleteModal: any, user: any} ) {
    ...
    return(
        <>
            <div onClick={() => setOpenDeleteModal(false)} className="fixed top-[50%] z-[90] left-[50%] translate-x-[-50%] translate-y-[-50%] h-screen w-full bg-[#000] bg-opacity-50 backdrop-blur-sm ">
